 ...
 * $Id: patchlevel.h,v 1.1.1.1 2001/10/16 18:05:30 provos Exp $
 *
 * $Log: patchlevel.h,v $
 * Revision 1.1.1.1  2001/10/16 18:05:30  provos
 * the first part of importing OpenBSD into stegdetect.
 *
